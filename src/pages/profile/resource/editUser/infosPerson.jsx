...
export const Pessoais = (props) => {
    return (
        ...
        <>
            <section className='w-full h-full border-4 rounded-lg border-black flex flex-row gap-10 md:pl-20 py-8'>
                <div>
                <h2 className=' font-4xl md:text-6xl font-bold font-sans'>Informações Pessoais</h2>
