            ...
            <div className='w-full h-full flex flex-col  border rounded-lg border-black gap-10 p-8'>
                ...
                <div className="flex justify-between items-center">
                    <div className='flex flex-col text-xl text-[#A9A9A9]'>
                        Nome de usuario
                        <input disabled={userInfosDisable.disable} onChange={handleNameChange} className={`text-black text-3xl p-1 ${userInfosDisable.class}`} defaultValue={form.nome} id="userInfo" />
                    </div>
                    <div className='flex flex-col text-xl text-[#A9A9A9]'>
                        E-mail
                        <input disabled={userInfosDisable.disable} onChange={handleEmailChange} className={`text-black text-3xl p-1 ${userInfosDisable.class}`} defaultValue={form.email} />
                    </div>
                ...
                <div className="flex justify-between">
                    <div className='flex flex-col text-xl text-[#A9A9A9]'>
                        Senha
                        <input type={password.type} id='password' disabled={password.disabled} onChange={handlePasswordChange} className={`text-black text-3xl p-1 ${password.class}`} defaultValue={password.password} />
                    </div>
                    <button
