        ...
        <>
                ...
                <section className='md:w-3/4 border-4 border-[#9ED1B7] rounded-lg  m-10 bg-white'>
                    <div className='p-2 md:p-20'>
                        <h1 className='flex justify-center text-3xl md:text-5xl font-semibold'>Selecione o animal</h1>
                        ...
                        <div className='flex xl:flex-row flex-col justify-between lg:gap-8 gap-2 w-full pl-14 md:pl-20 pt-5 md:pt-10'>
                    ...
                    <div className='p-5 md:pl-20 md:pr-20'>
                        <div className='flex mt-2 md:mt-10 justify-between'>
