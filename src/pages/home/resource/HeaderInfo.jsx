            ...
            <div className=" bg-[#9ED1B7] w-full h-full ">
                ...
                <div className="flex flex-col justify-items-center text-center p-10 gap-20 ml-80">
                        <div className=" ml-80 flex flex-col justify-center w-1/3 basis-1/4 content-center gap-20">
                            <h1 className=" font-bold text-7xl w-full h-3/4 rounded-lg bg-[#78A890] xl:text-9xl mt-20 ml-80"> Blog</h1>
                            <p className="flex justify-center xl:text-center text-4xl  w-full xl:ml-80">Tudo o que você precisa saber sobre os cuidados
                            com seu animal de estimação e curiosidas interressantes </p>
                        </div>
                    <img className=" mr-80 pr-20 pt-60 w-full" src={FootHeader}/>
