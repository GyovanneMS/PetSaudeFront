        ...
        <>
            <div className="bg-[#9ED1B7] flex flex-col pt-10 md:pt-28 md:mt-10 pb-10 md:pb-0">
                <div className=" flex justify-center items-center flex-row">
                    <div className="basis-1/3 md:basis-1/8 w-1/8 flex bg-yellow-300 items-center justify-evenly flex-col">
                    ...
                    <div className="basis-1/3 md:basis-1/8 w-1/8 flex bg-yellow-700 items-center flex-col content-evenly">
                    ...
                    <div className="basis-1/3 md:basis-1/8 flex items-center flex-col bg-yellow-500">
                    ...
                    <div className="basis-1/8 hidden md:flex flex-col items-center bg-yellow-200">
