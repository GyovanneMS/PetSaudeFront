        ...
        <>
            <div className="bg-[#9ED1B7] flex flex-col pt-10 md:pt-28 md:mt-10 pb-10 md:pb-0">
                <div className=" flex justify-evenly items-center flex-row">
                    <div className="basis-1/3 md:basis-1/8 flex justify-evenly flex-col">
                    ...
                    <div className="basis-1/3 md:basis-1/8 flex flex-col content-evenly">
                    ...
                    <div className="basis-1/3 md:basis-1/8">
                        <h5 className="font-semibold text-xs md:text-2xl flex items-center justify-center">App disponível :</h5>
                        <ul className="flex items-center justify-center flex-col gap-4 py-2 px-7 ">
                    ...
                    <div className="basis-1/8 hidden md:block">
                        <h5 className="flex text-xs md:text-2xl font-semibold font-montserrat items-center justify-center flex-row gap-4"><img src={Lupa} alt="Icone de uma lupa" className="w-7 y-7" /> Pesquise :</h5>
